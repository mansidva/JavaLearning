$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("E:/Eclipse/Selenium/FreeCrmBDDFramework/src/features/tagging.feature");
formatter.feature({
  "line": 2,
